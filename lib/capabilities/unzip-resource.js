...
function _handler(apiOptions, actions) {
  ...
  var dialogFilesText = selectedResources[0].name;

  var dialogNameText = getMessage('reallyUnzip', { files: dialogFilesText });
            ...
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  ...
                  _context.prev = 1;
                  _context.next = 4;
                  return _api2.default.unzipResource(apiOptions, selectedResources[0]);
...
exports.default = function (apiOptions, actions) {
  ...
  return {
    id: 'unzip',
    icon: { svg: _iconsSvg2.default.zip },
    label: localeLabel,
    shouldBeAvailable: function shouldBeAvailable(apiOptions) {
      ...
      return selectedResources.length === 1 && selectedResources.every(function (r) {
        return r.capabilities.canUnzip;
      });
