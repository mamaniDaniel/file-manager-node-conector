...
var unzipResource = function () {
  var _ref18 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee13(options, resource) {
    var route, method;
      ...
      while (1) {
        switch (_context15.prev = _context15.next) {
          case 0:
            ...
            route = options.apiRoot + '/files/' + resource.id;
            method = 'PUT';
            return _context15.abrupt('return', (0, _superagent2.default)(method, route));
  ...
  return function unzipResource(_x30, _x31) {
